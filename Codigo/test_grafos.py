...
'''@package docstring
Implementação de testes para as funções da Class MyGraph
'''
...
class TestGrafos(unittest.TestCase):   
    ...
    def setUp(self): 
        self.t1 = MyGraph( {1:[2], 2:[3], 3:[2,4], 4:[2]} )
        self.t2 = MyGraph()
    def test_get_nodes(self):
        self.assertEqual(self.t1.get_nodes(),[1, 2, 3, 4])
    def test_edges(self):
        self.assertEqual(self.t1.get_edges(),[(1, 2), (2, 3), (3, 2), (3, 4), (4, 2)])
    ...
    def test_distance(self):
        self.assertEqual(self.t1.distance(2,4),2)
        self.assertEqual(self.t1.distance(1,4),3)
        self.assertEqual(self.t1.distance(1,3),2)
        self.assertEqual(self.t1.distance(3,4),1)
    def test_shortest_path(self):
        self.assertEqual(self.t1.shortest_path(2,4),[2, 3, 4])
    ...
    def test_reachable_with_dist(self):
        self.assertEqual(self.t1.reachable_with_dist(1),[(2, 1), (3, 2), (4, 3)])
        self.assertEqual(self.t1.reachable_with_dist(4), [(2, 1), (3, 2)])
